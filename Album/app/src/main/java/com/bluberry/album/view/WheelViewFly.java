...
import com.threeti.zhonglianxun.R;
 ...
 */
public class WheelViewFly extends View {
	...
	private static int VALUE_TEXT_COLOR = 0xFF000000;

	/** Items text color */
	private static int ITEMS_TEXT_COLOR = 0x000000;

	/** Top and bottom shadows colors */
	//TODO ���ֱ���ɫ
	private static final int[] SHADOWS_COLORS = new int[] { 0x4c4c4c,
		0x4c4c4c, 0x4c4c4c };
	 ...
	 * Constructor
	 */
	public WheelViewFly(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public WheelViewFly(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
		this.context = context;
	}
	 ...
	 * Constructor
	 */
	public WheelViewFly(Context context) {
		super(context);
		this.context = context;
		initData(context);
	}
...
//			canvas.translate(10,0);
	...
	private void drawValue(Canvas canvas) {
		VALUE_TEXT_COLOR = context.getResources().getColor(R.color.t97ffff);
	...
	private void drawItems(Canvas canvas) {
		...
		ITEMS_TEXT_COLOR = context.getResources().getColor(R.color.white);//设置非选中区域颜色
		itemsPaint.setColor(ITEMS_TEXT_COLOR);
		itemsPaint.setTextSize(context.getResources().getDimensionPixelSize(R.dimen.dim25));//设置非选中区域大小
